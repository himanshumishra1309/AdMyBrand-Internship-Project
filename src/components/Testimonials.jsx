  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        >
          <div
            className={`inline-flex items-center gap-2 px-6 py-3 rounded-full border backdrop-blur-sm text-sm font-medium mb-6 transition-all duration-300 hover:scale-105 ${
              theme === "dark"
          ...
          >
            ...
            <span>Trusted by 50,000+ Marketing Teams</span>
          </div>
          ...
          <p
            className={`text-xl max-w-3xl mx-auto leading-relaxed ${theme === "dark" ? "text-slate-300" : "text-slate-600"}`}
          >
        ...
        >
          <div
            className={`relative backdrop-blur-sm rounded-3xl border shadow-2xl overflow-hidden transition-all duration-500 hover:shadow-3xl hover:scale-[1.02] ${
              theme === "dark"
          ...
          >
            ...
            {/* Quote Icon */}
            <div className="absolute top-8 right-8 p-3 rounded-2xl bg-gradient-to-r from-blue-500/20 to-indigo-500/20 backdrop-blur-sm">
              <Quote className="w-8 h-8 text-blue-500" />
            </div>

            <div className="relative p-8 lg:p-12">
              <div className={`grid lg:grid-cols-5 gap-8 items-center transition-all duration-500 ${
                ...
                <div className="lg:col-span-2 text-center lg:text-left">
                  <div className="relative inline-block mb-6">
                    <div className="relative">
                      {/* Loading placeholder */}
                      {imageLoading && (
                        <div className="w-32 h-32 rounded-3xl bg-gradient-to-br from-slate-200 to-slate-300 dark:from-slate-700 dark:to-slate-800 animate-pulse mx-auto lg:mx-0 border-4 border-white/50 shadow-2xl" />
                      )}
                      
                      {/* Actual image */}
                      <img
                        src={imageError ? "/placeholder.svg?height=128&width=128&text=User+Avatar" : testimonials[currentIndex].image}
                        alt={testimonials[currentIndex].name}
                        className={`w-32 h-32 rounded-3xl object-cover border-4 border-white/50 shadow-2xl mx-auto lg:mx-0 transition-all duration-700 hover:scale-105 ${
                      ...
                      {/* Professional badge */}
                      <div className="absolute -bottom-3 -right-3 w-12 h-12 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-2xl flex items-center justify-center shadow-lg transform rotate-12 hover:rotate-0 transition-transform duration-300">
                        <Star className="w-6 h-6 text-white" />
                      </div>

                      {/* Verified badge */}
                      <div className="absolute -top-2 -left-2 w-8 h-8 bg-green-500 rounded-full flex items-center justify-center shadow-lg">
                  ...
                  <div className="space-y-3">
                    <h4 className={`text-2xl font-bold transition-all duration-500 ${theme === "dark" ? "text-white" : "text-slate-900"}`}>
                      {testimonials[currentIndex].name}
                    </h4>
                    <div className="space-y-1">
                      <p className={`text-base font-medium transition-all duration-500 ${theme === "dark" ? "text-slate-300" : "text-slate-700"}`}>
                        {testimonials[currentIndex].role}
                      </p>
                      <p className="text-base font-semibold bg-gradient-to-r from-blue-500 to-indigo-500 bg-clip-text text-transparent transition-all duration-500">
                        {testimonials[currentIndex].company}
                      </p>
                      <div className={`text-sm transition-all duration-500 ${theme === "dark" ? "text-slate-400" : "text-slate-600"}`}>
                        <p>{testimonials[currentIndex].location}</p>
                        <p>{testimonials[currentIndex].companySize}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 mt-8">
                    <div
                      className={`p-4 rounded-2xl backdrop-blur-sm border transition-all duration-700 hover:scale-105 hover:shadow-lg ${
                        theme === "dark"
                    ...
                    >
                      <div className="text-3xl font-bold text-green-500 mb-1 transition-all duration-500">
                    ...
                    >
                      <div className="text-3xl font-bold text-blue-500 mb-1 transition-all duration-500">
                ...
                <div className="lg:col-span-3">
                  ...
                  {/* Quote */}
                  <blockquote
                    className={`text-xl lg:text-2xl leading-relaxed mb-6 transition-all duration-700 ${
                  ...
                  <div className="flex items-center justify-center lg:justify-start gap-4">
                    <Button
                      ...
                      className={`w-12 h-12 rounded-full backdrop-blur-sm transition-all duration-300 hover:scale-110 disabled:opacity-50 disabled:cursor-not-allowed ${
                        theme === "dark"
                        ...
                        <button
                          ...
                          className={`transition-all duration-500 rounded-full disabled:cursor-not-allowed ${
                            index === currentIndex
                              ...
                              : `w-3 h-3 ${theme === "dark" ? "bg-slate-600" : "bg-slate-300"} hover:bg-blue-400 ${isTransitioning ? "opacity-50" : "opacity-100"}`
                          }`}
                        />
                      ))}
                    </div>
